...
#ifndef __CMDLST_REG_REG_OFFSET_H__
#define __CMDLST_REG_REG_OFFSET_H__

/* CMDLST_REG Base addr of Module's Register */
#define SOC_CMDLST_REG_BASE                       (0xd000)
...
#define SOC_CMDLST_REG_CMDLST_HW_AXI_ADDR_DUMP_H_REG (SOC_CMDLST_REG_BASE + 0x28) /* AXI high addr Frame start for dump. */
#define SOC_CMDLST_REG_CMDLST_HW_AXI_ADDR_DUMP_L_REG (SOC_CMDLST_REG_BASE + 0x2C) /* AXI low addr Frame start for dump. */
...
#define SOC_CMDLST_REG_CMDLST_AXI_ADDR_RO_H_REG      (SOC_CMDLST_REG_BASE + 0x3C) /* AXI high addr frame start for debug. */
#define SOC_CMDLST_REG_CMDLST_AXI_ADDR_RO_L_REG      (SOC_CMDLST_REG_BASE + 0x40) /* AXI low addr frame start for debug. */

#endif // __CMDLST_REG_REG_OFFSET_H__
